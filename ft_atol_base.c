...
/*   Updated: 2018/06/18 19:21:35 by robert0          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** without modify *str
*/
static long	ft_chars_to_digits(const char *str, const char *base, int indx)
{
	long	ret_nb;
	size_t	count;
...
static int	ft_recurs_power(int nb, int power)
{
	if (power < 0)
		return (0);
	else if (power == 0)
